...
class FlsDetection(object):
    ...
    def pub_projected_img(self, ranges, thetas):
        ...
        # projected_image = np.zeros((996,730), dtype='uint8')
        projected_image = np.zeros((3384,2710), dtype='uint8')
        ...
        print(self.projected_image.dtype)

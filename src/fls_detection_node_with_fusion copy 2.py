...
class FlsDetection(object):
    ...
    def pub_projected_img(self, ranges, thetas):
        ...
        #projected_image = np.zeros((h,w), dtype = np.int8)
        ...
        #sonar_mask = sonar_mask.crop((50,0,1046,730))
        #print('projected_image')
        #print(self.projected_image)

        projected_image = projected_image[50:1046, 0: 730]
    ...
    def fuse_camera_and_sonar(self, camera_mask, sonar_mask):
        ...
        #sonar_mask = sonar_mask.crop((0,730))

        #sonar_mask = sonar_mask[50:1046, 0: 730]
        #print('sonar_mask')
        #print(sonar_mask.shape)
        #print('camera_mask')
        #print(camera_mask.shape)

        print('sonar_mask')
        print(sonar_mask.dtype)

        print('camera_mask')
        print(camera_mask.dtype)

        fused_image = sonar_mask.T * camera_mask

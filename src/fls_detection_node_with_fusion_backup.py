...
class FlsDetection(object):
    ...
    def __init__(self):
        ...
        # camera_image_subs= rospy.Subscriber("/sparus2/camera/image_raw", Image, self.camera_mask)
        # camera_info_subs = rospy.Subscriber("/sparus2/camera/image_raw/camera_info",CameraInfo,self.camera_info_callback)
    ...
    def camera_mask(self, camera_image):
        ...
        # cv_image = br.imgmsg_to_cv2(camera_image, "bgr8")

        # print(cv_image.shape)

        # rgb_img = cv2.cvtColor(cv_image, cv2.COLOR_BayerRG2RGB)
